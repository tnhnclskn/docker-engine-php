...
class TaskSpecContainerSpecNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Tnhnclskn\\Docker\\API\\Model\\TaskSpecContainerSpec';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Tnhnclskn\\Docker\\API\\Model\\TaskSpecContainerSpec';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('Privileges', $data) && $data['Privileges'] !== null) {
            $object->setPrivileges($this->denormalizer->denormalize($data['Privileges'], 'Tnhnclskn\\Docker\\API\\Model\\TaskSpecContainerSpecPrivileges', 'json', $context));
        }
        ...
        if (\array_key_exists('Mounts', $data) && $data['Mounts'] !== null) {
            ...
            foreach ($data['Mounts'] as $value_5) {
                $values_5[] = $this->denormalizer->denormalize($value_5, 'Tnhnclskn\\Docker\\API\\Model\\Mount', 'json', $context);
            }
        ...
        if (\array_key_exists('HealthCheck', $data) && $data['HealthCheck'] !== null) {
            $object->setHealthCheck($this->denormalizer->denormalize($data['HealthCheck'], 'Tnhnclskn\\Docker\\API\\Model\\HealthConfig', 'json', $context));
        }
        ...
        if (\array_key_exists('DNSConfig', $data) && $data['DNSConfig'] !== null) {
            $object->setDNSConfig($this->denormalizer->denormalize($data['DNSConfig'], 'Tnhnclskn\\Docker\\API\\Model\\TaskSpecContainerSpecDNSConfig', 'json', $context));
        }
        ...
        if (\array_key_exists('Secrets', $data) && $data['Secrets'] !== null) {
            ...
            foreach ($data['Secrets'] as $value_7) {
                $values_7[] = $this->denormalizer->denormalize($value_7, 'Tnhnclskn\\Docker\\API\\Model\\TaskSpecContainerSpecSecretsItem', 'json', $context);
            }
        ...
        if (\array_key_exists('Configs', $data) && $data['Configs'] !== null) {
            ...
            foreach ($data['Configs'] as $value_8) {
                $values_8[] = $this->denormalizer->denormalize($value_8, 'Tnhnclskn\\Docker\\API\\Model\\TaskSpecContainerSpecConfigsItem', 'json', $context);
            }
