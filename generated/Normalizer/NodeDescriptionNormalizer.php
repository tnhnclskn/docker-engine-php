...
class NodeDescriptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Tnhnclskn\\Docker\\API\\Model\\NodeDescription';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Tnhnclskn\\Docker\\API\\Model\\NodeDescription';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Tnhnclskn\Docker\API\Model\NodeDescription();
        if (null === $data) {
            return $object;
        }
        ...
        if (\array_key_exists('Platform', $data) && $data['Platform'] !== null) {
            $object->setPlatform($this->denormalizer->denormalize($data['Platform'], 'Tnhnclskn\\Docker\\API\\Model\\Platform', 'json', $context));
        }
        ...
        if (\array_key_exists('Resources', $data) && $data['Resources'] !== null) {
            $object->setResources($this->denormalizer->denormalize($data['Resources'], 'Tnhnclskn\\Docker\\API\\Model\\ResourceObject', 'json', $context));
        }
        ...
        if (\array_key_exists('Engine', $data) && $data['Engine'] !== null) {
            $object->setEngine($this->denormalizer->denormalize($data['Engine'], 'Tnhnclskn\\Docker\\API\\Model\\EngineDescription', 'json', $context));
        }
        ...
        if (\array_key_exists('TLSInfo', $data) && $data['TLSInfo'] !== null) {
            $object->setTLSInfo($this->denormalizer->denormalize($data['TLSInfo'], 'Tnhnclskn\\Docker\\API\\Model\\TLSInfo', 'json', $context));
        }
