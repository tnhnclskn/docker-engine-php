...
class PluginConfigNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Tnhnclskn\\Docker\\API\\Model\\PluginConfig';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Tnhnclskn\\Docker\\API\\Model\\PluginConfig';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Tnhnclskn\Docker\API\Model\PluginConfig();
        if (null === $data) {
            return $object;
        }
        ...
        if (\array_key_exists('Interface', $data) && $data['Interface'] !== null) {
            $object->setInterface($this->denormalizer->denormalize($data['Interface'], 'Tnhnclskn\\Docker\\API\\Model\\PluginConfigInterface', 'json', $context));
        }
        ...
        if (\array_key_exists('User', $data) && $data['User'] !== null) {
            $object->setUser($this->denormalizer->denormalize($data['User'], 'Tnhnclskn\\Docker\\API\\Model\\PluginConfigUser', 'json', $context));
        }
        elseif (\array_key_exists('User', $data) && $data['User'] === null) {
            $object->setUser(null);
        }
        if (\array_key_exists('Network', $data) && $data['Network'] !== null) {
            $object->setNetwork($this->denormalizer->denormalize($data['Network'], 'Tnhnclskn\\Docker\\API\\Model\\PluginConfigNetwork', 'json', $context));
        }
        ...
        if (\array_key_exists('Linux', $data) && $data['Linux'] !== null) {
            $object->setLinux($this->denormalizer->denormalize($data['Linux'], 'Tnhnclskn\\Docker\\API\\Model\\PluginConfigLinux', 'json', $context));
        }
        ...
        if (\array_key_exists('Mounts', $data) && $data['Mounts'] !== null) {
            ...
            foreach ($data['Mounts'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Tnhnclskn\\Docker\\API\\Model\\PluginMount', 'json', $context);
            }
        ...
        if (\array_key_exists('Env', $data) && $data['Env'] !== null) {
            ...
            foreach ($data['Env'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'Tnhnclskn\\Docker\\API\\Model\\PluginEnv', 'json', $context);
            }
        ...
        if (\array_key_exists('Args', $data) && $data['Args'] !== null) {
            $object->setArgs($this->denormalizer->denormalize($data['Args'], 'Tnhnclskn\\Docker\\API\\Model\\PluginConfigArgs', 'json', $context));
        }
        elseif (\array_key_exists('Args', $data) && $data['Args'] === null) {
            $object->setArgs(null);
        }
        if (\array_key_exists('rootfs', $data) && $data['rootfs'] !== null) {
            $object->setRootfs($this->denormalizer->denormalize($data['rootfs'], 'Tnhnclskn\\Docker\\API\\Model\\PluginConfigRootfs', 'json', $context));
        }
