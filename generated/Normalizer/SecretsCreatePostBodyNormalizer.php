...
class SecretsCreatePostBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Tnhnclskn\\Docker\\API\\Model\\SecretsCreatePostBody';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Tnhnclskn\\Docker\\API\\Model\\SecretsCreatePostBody';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Tnhnclskn\Docker\API\Model\SecretsCreatePostBody();
        ...
        if (\array_key_exists('Driver', $data) && $data['Driver'] !== null) {
            $object->setDriver($this->denormalizer->denormalize($data['Driver'], 'Tnhnclskn\\Docker\\API\\Model\\Driver', 'json', $context));
        }
        elseif (\array_key_exists('Driver', $data) && $data['Driver'] === null) {
            $object->setDriver(null);
        }
        if (\array_key_exists('Templating', $data) && $data['Templating'] !== null) {
            $object->setTemplating($this->denormalizer->denormalize($data['Templating'], 'Tnhnclskn\\Docker\\API\\Model\\Driver', 'json', $context));
        }
