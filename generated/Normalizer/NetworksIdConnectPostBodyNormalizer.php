...
class NetworksIdConnectPostBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Tnhnclskn\\Docker\\API\\Model\\NetworksIdConnectPostBody';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Tnhnclskn\\Docker\\API\\Model\\NetworksIdConnectPostBody';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Tnhnclskn\Docker\API\Model\NetworksIdConnectPostBody();
        if (null === $data) {
            return $object;
        }
        ...
        if (\array_key_exists('EndpointConfig', $data) && $data['EndpointConfig'] !== null) {
            $object->setEndpointConfig($this->denormalizer->denormalize($data['EndpointConfig'], 'Tnhnclskn\\Docker\\API\\Model\\EndpointSettings', 'json', $context));
        }
