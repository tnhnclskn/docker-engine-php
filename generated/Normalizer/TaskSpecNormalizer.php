...
class TaskSpecNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Tnhnclskn\\Docker\\API\\Model\\TaskSpec';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Tnhnclskn\\Docker\\API\\Model\\TaskSpec';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Tnhnclskn\Docker\API\Model\TaskSpec();
        if (null === $data) {
            return $object;
        }
        if (\array_key_exists('PluginSpec', $data) && $data['PluginSpec'] !== null) {
            $object->setPluginSpec($this->denormalizer->denormalize($data['PluginSpec'], 'Tnhnclskn\\Docker\\API\\Model\\TaskSpecPluginSpec', 'json', $context));
        }
        ...
        if (\array_key_exists('ContainerSpec', $data) && $data['ContainerSpec'] !== null) {
            $object->setContainerSpec($this->denormalizer->denormalize($data['ContainerSpec'], 'Tnhnclskn\\Docker\\API\\Model\\TaskSpecContainerSpec', 'json', $context));
        }
        ...
        if (\array_key_exists('NetworkAttachmentSpec', $data) && $data['NetworkAttachmentSpec'] !== null) {
            $object->setNetworkAttachmentSpec($this->denormalizer->denormalize($data['NetworkAttachmentSpec'], 'Tnhnclskn\\Docker\\API\\Model\\TaskSpecNetworkAttachmentSpec', 'json', $context));
        }
        ...
        if (\array_key_exists('Resources', $data) && $data['Resources'] !== null) {
            $object->setResources($this->denormalizer->denormalize($data['Resources'], 'Tnhnclskn\\Docker\\API\\Model\\TaskSpecResources', 'json', $context));
        }
        ...
        if (\array_key_exists('RestartPolicy', $data) && $data['RestartPolicy'] !== null) {
            $object->setRestartPolicy($this->denormalizer->denormalize($data['RestartPolicy'], 'Tnhnclskn\\Docker\\API\\Model\\TaskSpecRestartPolicy', 'json', $context));
        }
        ...
        if (\array_key_exists('Placement', $data) && $data['Placement'] !== null) {
            $object->setPlacement($this->denormalizer->denormalize($data['Placement'], 'Tnhnclskn\\Docker\\API\\Model\\TaskSpecPlacement', 'json', $context));
        }
        ...
        if (\array_key_exists('Networks', $data) && $data['Networks'] !== null) {
            ...
            foreach ($data['Networks'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Tnhnclskn\\Docker\\API\\Model\\NetworkAttachmentConfig', 'json', $context);
            }
        ...
        if (\array_key_exists('LogDriver', $data) && $data['LogDriver'] !== null) {
            $object->setLogDriver($this->denormalizer->denormalize($data['LogDriver'], 'Tnhnclskn\\Docker\\API\\Model\\TaskSpecLogDriver', 'json', $context));
        }
