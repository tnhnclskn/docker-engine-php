...
class TaskSpecPlacementNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Tnhnclskn\\Docker\\API\\Model\\TaskSpecPlacement';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Tnhnclskn\\Docker\\API\\Model\\TaskSpecPlacement';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Tnhnclskn\Docker\API\Model\TaskSpecPlacement();
        ...
        if (\array_key_exists('Preferences', $data) && $data['Preferences'] !== null) {
            ...
            foreach ($data['Preferences'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Tnhnclskn\\Docker\\API\\Model\\TaskSpecPlacementPreferencesItem', 'json', $context);
            }
        ...
        if (\array_key_exists('Platforms', $data) && $data['Platforms'] !== null) {
            ...
            foreach ($data['Platforms'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'Tnhnclskn\\Docker\\API\\Model\\Platform', 'json', $context);
            }
