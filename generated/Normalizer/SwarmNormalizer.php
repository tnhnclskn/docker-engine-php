...
class SwarmNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Tnhnclskn\\Docker\\API\\Model\\Swarm';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Tnhnclskn\\Docker\\API\\Model\\Swarm';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Tnhnclskn\Docker\API\Model\Swarm();
        if (null === $data) {
            return $object;
        }
        ...
        if (\array_key_exists('Spec', $data) && $data['Spec'] !== null) {
            $object->setSpec($this->denormalizer->denormalize($data['Spec'], 'Tnhnclskn\\Docker\\API\\Model\\SwarmSpec', 'json', $context));
        }
        ...
        if (\array_key_exists('JoinTokens', $data) && $data['JoinTokens'] !== null) {
            $object->setJoinTokens($this->denormalizer->denormalize($data['JoinTokens'], 'Tnhnclskn\\Docker\\API\\Model\\JoinTokens', 'json', $context));
        }
