...
class ContainerSummaryItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Tnhnclskn\\Docker\\API\\Model\\ContainerSummaryItem';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Tnhnclskn\\Docker\\API\\Model\\ContainerSummaryItem';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Tnhnclskn\Docker\API\Model\ContainerSummaryItem();
        ...
        if (\array_key_exists('Ports', $data) && $data['Ports'] !== null) {
            ...
            foreach ($data['Ports'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Tnhnclskn\\Docker\\API\\Model\\Port', 'json', $context);
            }
        ...
        if (\array_key_exists('HostConfig', $data) && $data['HostConfig'] !== null) {
            $object->setHostConfig($this->denormalizer->denormalize($data['HostConfig'], 'Tnhnclskn\\Docker\\API\\Model\\ContainerSummaryItemHostConfig', 'json', $context));
        }
        ...
        if (\array_key_exists('NetworkSettings', $data) && $data['NetworkSettings'] !== null) {
            $object->setNetworkSettings($this->denormalizer->denormalize($data['NetworkSettings'], 'Tnhnclskn\\Docker\\API\\Model\\ContainerSummaryItemNetworkSettings', 'json', $context));
        }
        ...
        if (\array_key_exists('Mounts', $data) && $data['Mounts'] !== null) {
            ...
            foreach ($data['Mounts'] as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, 'Tnhnclskn\\Docker\\API\\Model\\Mount', 'json', $context);
            }
